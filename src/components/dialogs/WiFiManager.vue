...
<template>
  <div class="dialog-overlay" @click.self="emit('close')">
    <div class="dialog wifi-dialog">
      ...
      <!-- 当前连接 -->
      <div v-if="robotStore.wifiScanResult.currentSsid" class="current-section">
      ...
      <div v-if="showAddForm" class="add-form">
        <input v-model="newSsid" type="text" placeholder="WiFi 名称 (SSID)" class="input-wifi" />
        <input v-model="newPassword" type="password" placeholder="密码（可选）" class="input-wifi" />
      ...
      <div class="network-list">
        ...
        <div v-if="sortedNetworks.length === 0 && !scanning" class="empty-list">未发现 WiFi 网络，请点击"重新扫描"</div>
      </div>

      <!-- 密码输入弹窗 -->
      <div v-if="showPasswordFor" class="password-overlay" @click.self="showPasswordFor = null">
